...
A sampling distribution refers to the probability distribution of a particular statisitc that we might get from a random sample. To think about this we'll employ an example. 
