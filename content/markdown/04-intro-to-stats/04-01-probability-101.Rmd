...
We can also hold the standard deviation constant and plot differnt mean values. Let's try that now: 
...
This likely looks much as we may have anticiipated. We are simply shifting the plot left or right depending on the mean. 
