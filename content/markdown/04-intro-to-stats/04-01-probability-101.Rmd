...
Now we'll combine all these data frames into one, and plot the result with a grouped bar chart: 
...
# plot the result 
ggplot() + 
  geom_bar(data = df_all_samples, 
           mapping = aes(x = base, y = prob, fill = sample),
