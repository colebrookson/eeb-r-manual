...
Differently to a probability distribution function, which has to by definition sum to 1 (the sum of all the possibilities can't be greater or less than 1), a likelihood function does <strong>not</strong> have to sum to 1. The function is in fact scaled such that the best-supported value has a likelihood of 1. 
